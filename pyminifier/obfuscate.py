...
def obfuscate_variable(
    tokens, index, replace, replacement, right_of_equal, inside_parens, inside_function
):
    """
...
def obfuscate(module, tokens, options, name_generator=None, table=None):
    ...
    *module* must be the name of the module we're currently obfuscating
    ...
    if options.obfuscate:
        ...
        for variable in variables:
            replace_obfuscatables(
                module, tokens, obfuscate_variable, variable, name_generator, table
            )
        for _class in classes:
            replace_obfuscatables(
        ...
        for function in functions:
            replace_obfuscatables(
                module, tokens, obfuscate_function, function, name_generator, table
            )
