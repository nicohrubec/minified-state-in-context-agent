...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--lexical",
        default="/Users/nicolashrubec/dev/agent-state-management/data/token-analysis/lexical_SWE-bench_Verified_test.csv",
        help="Path to lexical token CSV",
    )
    parser.add_argument(
        "--structural",
        default="/Users/nicolashrubec/dev/agent-state-management/data/token-analysis/structural_SWE-bench_Verified_test.csv",
